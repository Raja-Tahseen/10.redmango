...
//API integration is handled using Redux Toolkit Query (RTK Query). This file defines an API slice using RTK Query's createApi method. It provides a clean and efficient way to fetch data from the backend and manage caching, state updates, and invalidation.
